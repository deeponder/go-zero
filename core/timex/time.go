...
func NewTime(timestamp int64) Timex {
	tm := time.Unix(timestamp, 0)
	return Timex{tm}
}

func StrNewTime(timeStr string) Timex {
	now, _ := StrNewTimeEx(timeStr)
	return now
}

func StrNewTimeEx(timeStr string) (Timex, error) {
...
func NQGtime2Date00(specTime *Timex) *Date {
